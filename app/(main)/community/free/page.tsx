...
//     const [selectedTab, setSelectedTab] = useState("free");
//     const [searchQuery, setSearchQuery] = useState("");
//     const [commentCounts, setCommentCounts] = useState<{ [key: number]: number }>({}); // 댓글 수 상태
...
//                     try {
//                         // 각 게시글의 댓글을 가져오고 길이로 댓글 수를 계산
//                         const commentRes = await fetch(`/backend/community/${post.id}/comments`, {
//                             method: "GET",
//                             headers: { "Content-Type": "application/json" },
//                         });
...
//                 })
//             );
//             setCommentCounts(commentCounts); // 댓글 수 상태 업데이트
//         } catch (error) {
//             console.error("게시글 조회 실패:", error);
//         }
//     };
